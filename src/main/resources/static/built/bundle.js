...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      client({
        method: 'GET',
        path: '/api/unidades-de-ensino'
      }).done(function (response) {
        _this2.setState({
          unidadesDeEnsino: response.entity._embedded.unidadesDeEnsino
        });
      });
    }
  }, {
    ...
    value: function render() {
      return React.createElement(UnidadedesDeEnsinoList, {
        unidadesDeEnsino: this.state.unidadesDeEnsino
      });
    }
  }]);
...
var UnidadedesDeEnsinoList =
/*#__PURE__*/
function (_React$Component2) {
  _inherits(UnidadedesDeEnsinoList, _React$Component2);

  function UnidadedesDeEnsinoList() {
    _classCallCheck(this, UnidadedesDeEnsinoList);

    return _possibleConstructorReturn(this, _getPrototypeOf(UnidadedesDeEnsinoList).apply(this, arguments));
  }

  _createClass(UnidadedesDeEnsinoList, [{
    key: "render",
    value: function render() {
      var unidadesDeEnsino = this.props.unidadesDeEnsino.map(function (unidade) {
        return React.createElement(UnidadeDeEnsino, {
          key: unidade._links.self.href,
          unidadeDeEnsino: unidade
        });
      });
      return React.createElement("table", null, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("th", null, "First Name"), React.createElement("th", null, "Last Name"), React.createElement("th", null, "Description")), unidadesDeEnsino));
    }
  }]);

  return UnidadedesDeEnsinoList;
}(React.Component);

var UnidadeDeEnsino =
/*#__PURE__*/
function (_React$Component3) {
  _inherits(UnidadeDeEnsino, _React$Component3);

  function UnidadeDeEnsino() {
    _classCallCheck(this, UnidadeDeEnsino);

    return _possibleConstructorReturn(this, _getPrototypeOf(UnidadeDeEnsino).apply(this, arguments));
  }

  _createClass(UnidadeDeEnsino, [{
    key: "render",
    value: function render() {
      return React.createElement("tr", null, React.createElement("td", null, this.props.unidadeDeEnsino.nomeFantasia), React.createElement("td", null, this.props.unidadeDeEnsino.cnpj), React.createElement("td", null, this.props.unidadeDeEnsino.tipo));
    }
  }]);
